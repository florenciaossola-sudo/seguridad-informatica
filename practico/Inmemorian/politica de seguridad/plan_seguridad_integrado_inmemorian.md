# Plan Integrado de Seguridad de la Información — Inmemorian
...
1. [Alcance](#1-alcance)
   - [Síntesis transversal](#síntesis-de-medidas-transversales-de-implementación)
2. [Seguridad de la Información](#2-seguridad)
   - Implementación propuesta (al final del capítulo)
3. [Política de Seguridad de la Información](#3-política)
   - Implementación propuesta (al final del capítulo)
4. [Seguridad Frente al Acceso por Parte de Terceros](#4-seguridad)
   - Implementación propuesta (al final del capítulo)
5. [Clasificación y Control de Activos](#5-clasificación)
   - Implementación propuesta (al final del capítulo)
6. [Seguridad del Personal](#6-seguridad)
   - Implementación propuesta (al final del capítulo)
7. [Seguridad Física y Ambiental](#7-seguridad)
   - Implementación propuesta (al final del capítulo)
8. [Gestión de Comunicaciones y Operaciones](#8-gestión)
   - Implementación propuesta (al final del capítulo)
9. [Control de Accesos](#9-control)
   - Implementación propuesta (al final del capítulo)
10. [Desarrollo y Mantenimiento de Sistemas](#10-desarrollo)
   - Implementación propuesta (al final del capítulo)
11. [Administración de la Continuidad de las Actividades de la Organización](#11-administración)
   - Implementación propuesta (al final del capítulo)
...
## Síntesis de medidas transversales de implementación
...
> **Correlación con implementación:**
...
*Fuente: Medidas de Implementación y Plan de Acción — Capítulo 2*

> **Referencias cruzadas:** Wazuh (cap. 2, 4, 8, 9, 11, 12); NAS (cap. 2, 7, 8, 11).
...
*Fuente: Medidas de Implementación y Plan de Acción — Capítulo 3*
...
*Fuente: Medidas de Implementación y Plan de Acción — Capítulo 4*

> **Referencias cruzadas:** FortiGate (cap. 4, 8, 9); Wazuh (cap. 2, 4, 8, 9, 11, 12).
...
*Fuente: Medidas de Implementación y Plan de Acción — Capítulo 5*
...
*Fuente: Medidas de Implementación y Plan de Acción — Capítulo 6*
...
*Fuente: Medidas de Implementación y Plan de Acción — Capítulo 7*
...
*Fuente: Medidas de Implementación y Plan de Acción — Capítulo 8*

> **Referencias cruzadas:** Wazuh (cap. 2, 4, 8, 9, 11, 12); NAS (cap. 2, 7, 8, 11); FortiGate (cap. 4, 8, 9).
...
*Fuente: Medidas de Implementación y Plan de Acción — Capítulo 9*

> **Referencias cruzadas:** Wazuh (cap. 2, 4, 8, 9, 11, 12); FortiGate (cap. 4, 8, 9).
...
*Fuente: Medidas de Implementación y Plan de Acción — Capítulo 10*
...
*Fuente: Medidas de Implementación y Plan de Acción — Capítulo 11*

> **Referencias cruzadas:** NAS (cap. 2, 7, 8, 11); Wazuh (cap. 2, 4, 8, 9, 11, 12); Veeam (cap. 2, 8, 11).
...
*Fuente: Medidas de Implementación y Plan de Acción — Capítulo 12*

> **Referencias cruzadas:** Wazuh (cap. 2, 4, 8, 9, 11, 12); GLPI (cap. 5, 10, 12).
