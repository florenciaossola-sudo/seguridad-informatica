...
Considerando la actual dependencia del 75% de los sistemas informáticos y la inexistencia de controles de respaldo, es fundamental establecer medidas inmediatas para proteger los procesos críticos mediante una combinación de controles preventivos y acciones de recuperación.
...
## **Alcance**
Esta Política se aplica a todos los procesos críticos identificados de la Organización: Ventas, Compras, Logística, Finanzas, Producción, Importaciones y Sistemas. Se aplica a las tres locaciones de la empresa: Parque Industrial, Local Inmemorian y Local La Roca.
## **Responsabilidad**
Seguridad de la Información participará en la definición, documentación y actualización de los planes de contingencia.

Los Propietarios de la Información y Seguridad de la Información cumplirán las siguientes funciones:

• Identificar las amenazas que puedan ocasionar interrupciones de los procesos y/o las actividades de la Organización, incluyendo: fallas de equipamiento, pérdida de datos, interrupción del suministro eléctrico, cortes de conectividad a Internet, desastres naturales, accesos no autorizados y ataques informáticos.

• Evaluar los riesgos para determinar el impacto de dichas interrupciones, considerando especialmente la falta actual de respaldos de información.

• Elaborar los planes de contingencia necesarios para garantizar la continuidad de las actividades de la Organización.

• Identificar y priorizar los procesos críticos de las actividades de la Organización. La presente política considera que todos los procesos son críticos para la operación.

• Asegurar que todos los integrantes de la Organización comprendan los riesgos que la misma enfrenta, en términos de probabilidad de ocurrencia e impacto de posibles amenazas, así como los efectos que una interrupción puede tener en la actividad de la Organización.

• Coordinar actualizaciones periódicas de los planes y procesos implementados, al menos semestralmente.
...
• Identificar los eventos (amenazas) que puedan ocasionar interrupciones en los procesos de las actividades, tales como: fallas en el equipamiento informático, interrupción del suministro de energía eléctrica, cortes de conectividad a Internet en las tres locaciones, daño físico a las instalaciones (incendio, inundación), robo de equipos, ataque informático, falla de sistemas ERP, pérdida de datos críticos de clientes o proveedores, y corrupción de bases de datos.
...
• Identificar los controles preventivos tales como sistemas de supresión de fuego, detectores de humo, contenedores resistentes al calor, estabilizadores de energía para equipos críticos, conexiones redundantes a Internet en locaciones operativas, y políticas de resguardo seguro de información crítica.

• Para Inmemoriam, dada su dependencia del 75% en sistemas informáticos y la ausencia de respaldos, la restauración de datos será considerada como Crítica Urgente. El Propietario de la Información (Gerencia de Sistemas a través del proveedor externo) deberá implementar un programa inmediato de respaldos regulares y pruebas de restauración.

Esta actividad será llevada a cabo con la activa participación de los Propietarios de la información y Seguridad de la Información.
## **11.2. Elaboración e Implementación de los Planes de Continuidad**
Los Propietarios de la información y Seguridad de la Información elaborarán los planes de contingencia necesarios para garantizar la continuidad de las actividades de la Organización.

El proceso de planificación de la continuidad de las actividades considerará los siguientes puntos:

• Analizar los posibles escenarios de contingencia y definir las acciones correctivas a implementar en cada caso, incluyendo: escenarios de pérdida total de datos, indisponibilidad de sistemas ERP, cortes prolongados de energía, cortes de conectividad a Internet, falla en servidor compartido entre locaciones, y acceso no autorizado a información sensible.

• Implementar procedimientos de emergencia para permitir la recuperación y restablecimiento en los plazos requeridos. Se debe dedicar especial atención a la evaluación de las dependencias de actividades externas (proveedores de servicios de sistemas, conexión a Internet) y a los contratos vigentes con terceros que brindan soporte a Sistemas, Finanzas e Importaciones.

• Establecer procedimientos operativos alternativos en caso de indisponibilidad de sistemas (ejemplo: registros manuales de ventas y pedidos, procedimientos offline para procesos críticos).

• Documentar los procedimientos y procesos acordados de manera clara y detallada, asignando responsabilidades específicas por proceso y por locación.

• Probar y actualizar los planes periódicamente (al menos semestralmente), realizando simulacros de contingencia que incluyan validación de restauración de datos y recuperación de servicios críticos.

• Mantener lista de contactos de emergencia actualizada incluyendo: personal clave de la Organización, proveedor externo de sistemas, proveedores de servicios críticos, y organismos externos relevantes.
